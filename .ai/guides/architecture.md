Server-side architecture overview | Screeps Documentation
...
## [](#Script-running-environment)Script running environment[](#Script-running-environment)
...
3. [Scaling](#Scaling)
4. [Script running environment](#Script-running-environment)
