Modifying object prototypes | Screeps Documentation
...
Contributed by [Helam](https://screeps.com/a/#!/profile/Helam) on May 14, 2017
...
## [](#What-are-prototypes)What are prototypes?[](#What-are-prototypes)
...
## [](#Adding-methods-to-a-prototype)Adding methods to a prototype[](#Adding-methods-to-a-prototype)
...
### [](#Storing-the-original-method)Storing the original method[](#Storing-the-original-method)
...
### [](#Working-with-arbitrary-arguments-list)Working with arbitrary arguments list[](#Working-with-arbitrary-arguments-list)
...
#### [](#Function-apply)[Function.apply](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function/apply)[](#Function-apply)
...
#### [](#Spawn-spawnCreep-Automatic-naming)[Spawn.spawnCreep](http://docs.screeps.com/api/#StructureSpawn.spawnCreep) - Automatic naming[](#Spawn-spawnCreep-Automatic-naming)
...
#### [](#StructureObserver-observeRoom-prevent-overriding-calls)[StructureObserver.observeRoom](http://docs.screeps.com/api/#StructureObserver) - prevent overriding calls[](#StructureObserver-observeRoom-prevent-overriding-calls)
...
## [](#Adding-properties-to-a-prototype)Adding properties to a prototype[](#Adding-properties-to-a-prototype)
...
### [](#Basic-property-with-getter-only-and-no-caching)Basic property with getter only and no caching[](#Basic-property-with-getter-only-and-no-caching)
...
### [](#Local-object-caching)Local object caching[](#Local-object-caching)
...
### [](#Adding-a-setter)Adding a setter[](#Adding-a-setter)
...
### [](#Memory-caching)Memory caching[](#Memory-caching)
...
### [](#Other-examples-1)Other examples[](#Other-examples-1)

#### [](#Creep-prototype-isFull-are-your-carry-parts-full)Creep.prototype.isFull - are your carry parts full?[](#Creep-prototype-isFull-are-your-carry-parts-full)
...
#### [](#Source-memory-Adding-memory-to-things)Source.memory - (Adding memory to things)[](#Source-memory-Adding-memory-to-things)
...
#### [](#Source-freeSpaceCount-How-many-creeps-can-you-fit-near-that-source)Source.freeSpaceCount - How many creeps can you fit near that source?[](#Source-freeSpaceCount-How-many-creeps-can-you-fit-near-that-source)
...
2. [Adding methods to a prototype](#Adding-methods-to-a-prototype)[Storing the original method](#Storing-the-original-method)
3. [Working with arbitrary arguments list](#Working-with-arbitrary-arguments-list)[Function.apply](#Function-apply)
[Other examples](#Other-examples)1. [Spawn.spawnCreep - Automatic naming](#Spawn-spawnCreep-Automatic-naming)
2. [StructureObserver.observeRoom - prevent overriding calls](#StructureObserver-observeRoom-prevent-overriding-calls)
[Adding properties to a prototype](#Adding-properties-to-a-prototype)1. [Basic property with getter only and no caching](#Basic-property-with-getter-only-and-no-caching)
2. [Local object caching](#Local-object-caching)
3. [Adding a setter](#Adding-a-setter)
4. [Memory caching](#Memory-caching)
5. [Other examples](#Other-examples-1)[Creep.prototype.isFull - are your carry parts full?](#Creep-prototype-isFull-are-your-carry-parts-full)
6. [Source.memory - (Adding memory to things)](#Source-memory-Adding-memory-to-things)
7. [Source.freeSpaceCount - How many creeps can you fit near that source?](#Source-freeSpaceCount-How-many-creeps-can-you-fit-near-that-source)
