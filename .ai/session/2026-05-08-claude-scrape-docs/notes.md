...
**Key Decisions:**
- One `.md` file per API class/object section → `.ai/api-reference/`
...
**Results:**
- API Reference: 53 reference files plus `README.md`, ~10KB total markdown
...
- Guides: 24 guide files plus `README.md` (21 root pages + 3 contributed articles)
  ...
  - Other (3): architecture, auth-tokens, third-party
