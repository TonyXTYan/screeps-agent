...
export const MAX_CARRY_CAPACITY = 1500;
const PATROL_BODY_TEMPLATES: BodyPartConstant[][] = [
    [TOUGH, TOUGH, ATTACK, ATTACK, ATTACK, RANGED_ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, MOVE, HEAL],
    [TOUGH, TOUGH, ATTACK, ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, MOVE, HEAL],
    [TOUGH, ATTACK, ATTACK, RANGED_ATTACK, MOVE, MOVE, MOVE, MOVE, HEAL],
    [TOUGH, ATTACK, MOVE, MOVE, HEAL],
    [ATTACK, MOVE, MOVE, HEAL],
