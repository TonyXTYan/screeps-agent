...
export function selectLargestWithinBudget(candidates: BodyPartConstant[][], energyBudget: number): BodyPartConstant[] {
...
export function planStaticRemoteMinerBody(energyBudget: number, hasContainer: boolean): BodyPartConstant[] {
    if (hasContainer) {
...
export function planMineralMinerBody(energyBudget: number): BodyPartConstant[] {
    return selectLargestWithinBudget([
...
export function planMinerBody(energyBudget: number, staticMining: boolean): BodyPartConstant[] {
    if (staticMining) {
        return selectLargestWithinBudget([
...
export function planHaulerBody(energyBudget: number, archetype: 'hauler' | 'remoteHauler'): BodyPartConstant[] {
...
export function planRemoteMaintainerBody(energyBudget: number): BodyPartConstant[] {
    return selectLargestWithinBudget([
...
export function planRemoteScoutBody(energyBudget: number): BodyPartConstant[] {
    return selectLargestWithinBudget([
        [MOVE, MOVE],
        [MOVE]
    ], energyBudget);
...
export function planDoctorBody(energyBudget: number): BodyPartConstant[] {
    return selectLargestWithinBudget([
...
export function buildClaimerBody(energyBudget: number, minClaimParts: number, maxClaimParts: number = 5): BodyPartConstant[] {
...
export function buildWorkerBody(energyBudget: number, workRatio: number = 1): BodyPartConstant[] {
    const body: BodyPartConstant[] = [];
