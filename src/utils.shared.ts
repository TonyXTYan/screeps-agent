...
/**
 * Returns the closest RoomObject to a creep by Chebyshev range.
 * Does not check path reachability; use findClosestByPath for that.
 */
...
/**
 * Returns the closest RoomObject to an arbitrary origin by Chebyshev range.
 * Accepts any RoomObject as origin (not just creeps).
 */
